...
pub struct ChatApp {
    ...
    current_turn_timeline_start: Option<usize>,
    current_turn_structured_response_raw: Option<String>,
    current_turn_structured_entry_index: Option<usize>,
    current_turn_contract_delta: Option<crate::agent::protocol::AssistantContractDelta>,
    current_turn_contract_delta_seen: bool,
...
impl ChatApp {
    pub fn new(repo_path: &str) -> Result<Self, AgentRuntimeError> {
        ...
        Ok(Self {
            ...
            current_turn_timeline_start: None,
            current_turn_structured_response_raw: None,
            current_turn_structured_entry_index: None,
            current_turn_contract_delta: None,
            current_turn_contract_delta_seen: false,
